...
export default class Invert extends HeavensDoor {
  /**
  ...
  constructor(category, ...args) {
    ...
    this.register(Invert, {
      ...
      name: 'heavens door invert',
      aliases: [],
      description: 'Invert an image',
      usage: 'heavens door invert [image resolvable]',
      params: [
        {
  ...
  modifyImage() {
    return this.sharp(this.filename).negate().toBuffer()
  }
}
