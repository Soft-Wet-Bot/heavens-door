...
export default class Swirl extends HeavensDoor {
  /**
  ...
  constructor(category, ...args) {
    ...
    this.register(Swirl, {
      ...
      name: 'heavens door swirl',
      aliases: [],
      description: 'Swirls an image',
      usage: 'heavens door swirl [image resolvable]',
      params: [
        {
  ...
  modifyImage() {
    const image = this.gm(this.filename).swirl(180).strip()
