...
export default class Sharp extends HeavensDoor {
  /**
  ...
  constructor(category, ...args) {
    ...
    this.register(Sharp, {
      ...
      name: 'heavens door sharp',
      aliases: ['sharpen', '#'],
      description: 'Sharp an image',
      usage: 'heavens door sharp [image resolvable]',
      params: [
        {
  ...
  modifyImage() {
    return this.sharp(this.filename).sharpen(4).toBuffer()
  }
}
