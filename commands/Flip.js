...
export default class Flip extends HeavensDoor {
  /**
  ...
  constructor(category, ...args) {
    ...
    this.register(Flip, {
      ...
      name: 'heavens door flip',
      aliases: [],
      description: 'Flips an image over its horizontal axis',
      usage: 'heavens door flip [image resolvable]',
      params: [
        {
  ...
  modifyImage() {
    return this.sharp(this.filename).flip().toBuffer()
  }
}
