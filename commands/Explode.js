...
export default class Explode extends HeavensDoor {
  /**
  ...
  constructor(category, ...args) {
    ...
    this.register(Explode, {
      category: category,

      name: 'heavens door explode',
      aliases: [],
      description: 'Explodes an image',
  ...
  modifyImage() {
    const image = this.gm(this.filename).implode([-2]).strip()
